CREATE DATABASE  IF NOT EXISTS `order_processing_system` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `tbl_invoice` VALUES (1,'2021-09-01',2,2,'inter-state',275,'Paid'),(2,'2021-09-20',6,2,'same state',660,'Paid'),(3,'2021-09-21',5,1,'same state',550,'Unpaid');
...
INSERT INTO `tbl_order` VALUES (1,'2021-09-21',1,'customer shipping address 1',100,10,'bluedart','Pending'),(2,'2021-09-02',2,'customer shipping address 2',250,25,'bluedart','Completed'),(3,'2021-09-21',1,'customer shipping address 3',300,30,'bluedart','Pending'),(4,'2021-09-21',2,'customer shipping address 4',400,450,'bluedart','Pending'),(5,'2021-09-21',1,'customer shipping address 5',500,50,'bluedart','Approved'),(6,'2021-09-21',2,'customer shipping address 6',600,60,'bluedart','Completed');
...
CREATE TABLE `tbl_product` (
  ...
  `category` enum('level_1','level_2','level_3') DEFAULT NULL,
...
INSERT INTO `tbl_product` VALUES (1,'Headphones',100,'level_1',3),(2,'iPhone',1000,'level_2',2),(3,'iPad',600,'level_2',2),(4,'Debit Card',5,'level_3',1),(5,'Credit Card',5,'level_3',1),(6,'Earbuds',150,'level_1',3);
...
-- Dump completed on 2021-09-22 22:35:17
